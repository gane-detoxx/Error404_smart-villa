...
class XDSmartGarage extends StatelessWidget {
  XDSmartGarage({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            offset: Offset(10.0, 528.0),
            child: SizedBox(
              width: 360.0,
              child: Text(
                'BUZZER TONE : SET YOUR PREFERRED ALERT TONE ',
                style: TextStyle(
                  fontFamily: 'Arial',
                  fontSize: 12,
                  color: const Color(0xffffffff),
...
const String _svg_e3uujf =
    '<svg viewBox="20.0 140.0 340.0 325.9" ><path transform="translate(20.0, 140.0)" d="M 0 0 L 340 0 L 340 325.8927612304688 L 0 325.8927612304688 L 0 0 Z" fill="#000000" fill-opacity="0.33" stroke="none" stroke-width="1" stroke-opacity="0.33" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
...
const String _svg_maykx8 =
    '<svg viewBox="19.0 623.0 28.0 31.0" ><path transform="translate(-22.0, -250.0)" d="M 69 886.5625 L 69 890.4375 L 47.65000152587891 890.4375 L 57.44999694824219 901.2874755859375 L 55 904 L 41 888.5 L 55 873 L 57.45000457763672 875.7125244140625 L 47.65000915527344 886.5625 L 69 886.5625 Z" fill="#000000" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_5stqvt =
    '<svg viewBox="51.5 542.5 85.0 1.0" ><path transform="translate(51.5, 542.5)" d="M 0 0 L 85 0" fill="none" stroke="#ffffff" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
