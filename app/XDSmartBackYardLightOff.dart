...
class XDSmartBackYardLightOff extends StatelessWidget {
  XDSmartBackYardLightOff({
    Key key,
  }) : super(key: key);
  @override
...
const String _svg_yq6h9w =
    '<svg viewBox="47.5 524.5 218.0 37.0" ><path transform="translate(64.5, 524.5)" d="M 0 0 L 26 0" fill="none" stroke="#ffffff" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /><path transform="translate(47.5, 561.5)" d="M 0 0 L 72 0" fill="none" stroke="#ffffff" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /><path transform="translate(115.5, 541.5)" d="M 0 0 L 150 0" fill="none" fill-opacity="0.25" stroke="#ffffff" stroke-width="1" stroke-opacity="0.25" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
