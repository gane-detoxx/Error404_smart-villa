...
import './XDMe.dart';
import './XDGenerateQRCode.dart';
import 'package:flutter_svg/flutter_svg.dart';

class XDDoorLock extends StatelessWidget {
  XDDoorLock({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      body: Stack(
        children: <Widget>[
              ...
              child: SizedBox(
                ...
                child: Stack(
                  children: <Widget>[
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(25.0, 3.0, 90.0, 14.0),
                      size: Size(140.0, 20.0),
                      fixedWidth: true,
                      fixedHeight: true,
                      child: Text(
                  ...
                  Pinned.fromSize(
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        color: const Color(0xc9ffffff),
                        border: Border.all(
                            width: 1.0, color: const Color(0xc9707070)),
                      ),
                    ),
                  ),
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(26.5, 3.0, 88.0, 14.0),
                    size: Size(140.0, 20.0),
                    fixedWidth: true,
                    fixedHeight: true,
                    child: Text(
          ...
          Transform.translate(
            offset: Offset(10.8, 418.5),
            child: SizedBox(
              width: 360.0,
              child: Text(
                'OPEN DOOR LOCK : CLICKING THIS BUTTON GENERATES A QR CODE WHICH IS TO BE THEN SCANNED BY SCANNER IN THE DOOR AND ALLOWS YOU TO SHARE THE QR CODE TO WHOM YOU WANT TO LET INTO THE HOUSE ',
                style: TextStyle(
                  fontFamily: 'Arial',
                  fontSize: 12,
                  color: const Color(0xffffffff),
          ...
          Transform.translate(
            offset: Offset(10.3, 512.0),
            child: SizedBox(
              width: 360.0,
              child: Text(
                'LOCK DOOR LOCK : CLICKING THIS BUTTON LOCKS THE DOOR  ',
                style: TextStyle(
                  fontFamily: 'Arial',
                  fontSize: 12,
                  color: const Color(0xffffffff),
...
const String _svg_n5lsyp =
    '<svg viewBox="60.8 431.5 109.8 1.0" ><path transform="translate(60.75, 431.5)" d="M 0 0 L 109.75 0" fill="none" stroke="#ffffff" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_solrqr =
    '<svg viewBox="60.3 503.0 205.3 23.0" ><path transform="translate(60.25, 526.0)" d="M 0 0 L 112 0" fill="none" stroke="#ffffff" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /><path transform="translate(115.5, 503.0)" d="M 0 0 L 150 0" fill="none" fill-opacity="0.25" stroke="#ffffff" stroke-width="1" stroke-opacity="0.25" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
