...
import './XDMe.dart';
import './XDAutomatedFanandLightOff.dart';
import 'package:flutter_svg/flutter_svg.dart';

class XDAutomatedFanandLightOn extends StatelessWidget {
  XDAutomatedFanandLightOn({
    Key key,
  }) : super(key: key);
  @override
...
const String _svg_uclzzw =
    '<svg viewBox="225.0 371.0 112.0 38.0" ><path transform="translate(225.0, 380.0)" d="M 0 0 L 0 20" fill="none" stroke="#ffffff" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /><path transform="translate(337.0, 371.0)" d="M 0 0 L 0 38" fill="none" stroke="#ffffff" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /><path transform="translate(281.0, 374.0)" d="M 0 0 L 0 32" fill="none" stroke="#ffffff" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
