...
import './XDMe.dart';
import './XDSmartBackYardLightOff.dart';
import 'package:flutter_svg/flutter_svg.dart';

class XDSmartBackYardLightOn extends StatelessWidget {
  XDSmartBackYardLightOn({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            offset: Offset(11.0, 512.0),
            child: SizedBox(
              width: 360.0,
              child: Text(
                'TIME : THE LIGHT TURNS ON IF IT SENSES OUR PRESENCE FOR THIS SPECIFIED AMOUNT OF TIME',
                style: TextStyle(
                  fontFamily: 'Arial',
                  fontSize: 11,
                  color: const Color(0xffffffff),
          ...
          Transform.translate(
            offset: Offset(15.8, 549.5),
            child: SizedBox(
              width: 350.0,
              child: Text(
                'BRIGHTNESS : ADJUST THE BRIGHTNESS BASED ON YOUR NEEDS',
                style: TextStyle(
                  fontFamily: 'Arial',
                  fontSize: 11,
                  color: const Color(0xffffffff),
...
const String _svg_pn299e =
    '<svg viewBox="259.0 242.0 5.0 14.0" ><path transform="translate(259.0, 242.0)" d="M 2.5 0 L 5 5 L 0 5 L 2.5 0 Z" fill="#ffffff" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /><path transform="matrix(-1.0, 0.0, 0.0, -1.0, 264.0, 256.0)" d="M 2.5 0 L 5 5 L 0 5 L 2.5 0 Z" fill="#ffffff" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
...
const String _svg_usqq0y =
    '<svg viewBox="47.5 524.5 72.0 37.0" ><path transform="translate(64.5, 524.5)" d="M 0 0 L 26 0" fill="none" stroke="#ffffff" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /><path transform="translate(47.5, 561.5)" d="M 0 0 L 72 0" fill="none" stroke="#ffffff" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_7ge5iw =
    '<svg viewBox="115.5 541.5 150.0 1.0" ><path transform="translate(115.5, 541.5)" d="M 0 0 L 150 0" fill="none" fill-opacity="0.25" stroke="#ffffff" stroke-width="1" stroke-opacity="0.25" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
