...
import './XDMe.dart';
import './XDAutomaticDoorbellOff.dart';
import 'package:flutter_svg/flutter_svg.dart';

class XDAutomaticDoorbellOn extends StatelessWidget {
  XDAutomaticDoorbellOn({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            offset: Offset(7.4, 503.5),
            child: SizedBox(
              width: 367.0,
              child: Text(
                'TIME : THE DOORBELL RINGS IF IT SENSES THE VISITOR\'S PRESENSE FOR THIS SPECIFIED AMOUNT OF TIME',
                style: TextStyle(
                  fontFamily: 'Arial',
                  fontSize: 10,
                  color: const Color(0xffffffff),
          ...
          Transform.translate(
            offset: Offset(14.6, 538.0),
            child: SizedBox(
              width: 353.0,
              child: Text(
                'DURATION : SPECIFY THE DURATION FOR WHICH THE DOORBELL SHOULD RING',
                style: TextStyle(
                  fontFamily: 'Arial',
                  fontSize: 10,
                  color: const Color(0xffffffff),
          ...
          Transform.translate(
            offset: Offset(11.0, 572.0),
            child: SizedBox(
              width: 360.0,
              child: Text(
                'TONE : SET YOUR PREFERRED DOORBELL TONE',
                style: TextStyle(
                  fontFamily: 'Arial',
                  fontSize: 10,
                  color: const Color(0xffffffff),
...
const String _svg_5ngdzp =
    '<svg viewBox="20.0 140.0 340.0 340.0" ><path transform="translate(20.0, 140.0)" d="M 0 0 L 340 0 L 340 340 L 0 340 L 0 0 Z" fill="#000000" fill-opacity="0.33" stroke="#707070" stroke-width="1" stroke-opacity="0.11" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_xaf9pg =
    '<svg viewBox="260.0 243.0 7.0 194.0" ><path transform="translate(260.0, 243.0)" d="M 2.5 0 L 5 5 L 0 5 L 2.5 0 Z" fill="#ffffff" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /><path transform="translate(262.0, 423.0)" d="M 2.5 0 L 5 5 L 0 5 L 2.5 0 Z" fill="#ffffff" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /><path transform="matrix(-1.0, 0.0, 0.0, -1.0, 265.0, 257.0)" d="M 2.5 0 L 5 5 L 0 5 L 2.5 0 Z" fill="#ffffff" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /><path transform="matrix(-1.0, 0.0, 0.0, -1.0, 267.0, 437.0)" d="M 2.5 0 L 5 5 L 0 5 L 2.5 0 Z" fill="#ffffff" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
...
const String _svg_ra52y8 =
    '<svg viewBox="48.5 514.5 65.0 69.0" ><path transform="translate(48.5, 514.5)" d="M 0 0 L 27 0" fill="none" stroke="#ffffff" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /><path transform="translate(56.5, 550.5)" d="M 0 0 L 57 0" fill="none" stroke="#ffffff" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /><path transform="translate(69.5, 583.5)" d="M 0 0 L 32 0" fill="none" stroke="#ffffff" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_w7gnl =
    '<svg viewBox="115.5 532.5 150.0 35.0" ><path transform="translate(115.5, 532.5)" d="M 0 0 L 150 0" fill="none" fill-opacity="0.25" stroke="#ffffff" stroke-width="1" stroke-opacity="0.25" stroke-miterlimit="4" stroke-linecap="butt" /><path transform="translate(115.5, 567.5)" d="M 0 0 L 150 0" fill="none" fill-opacity="0.25" stroke="#ffffff" stroke-width="1" stroke-opacity="0.25" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
